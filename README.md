...
## Additional Viewer: Snake Renderer

An independent snake scene renderer was added using `pygame-ce`.
See [`SNAKE_VIEWER.md`](SNAKE_VIEWER.md) for architecture and run instructions.
